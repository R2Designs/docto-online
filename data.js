...
{id:"sleep_apnoea", rg:"chest", nm:"Obstructive sleep apnoea (suspected)", refer:true,
 al:["snoring","snore loudly","stop breathing at night","stops breathing in sleep","gasping in sleep","choking in sleep",
  "sleepy all day","falling asleep at work","kharaate","kharatte","apnea","apnoea","daytime sleepiness","unrefreshing sleep",
  "wife says i stop breathing","witnessed pauses"],
 sys:"respiratory", doctor:"Pulmonologist / ENT (sleep study)",
 modern:[
  {t:"Loud snoring with witnessed pauses in breathing, gasping awakenings and daytime sleepiness is the classic picture of obstructive sleep apnoea. The throat closes repeatedly in sleep, so the night gives no real rest."},
  {t:"This matters beyond tiredness: untreated apnoea raises blood pressure and the long-term risk of heart disease, stroke, diabetes and road accidents. It is worth diagnosing properly."},
  {t:"The diagnosis is a sleep study (polysomnography or a home sleep test). No tablet, syrup or nasal spray substitutes for it, and self-treating snoring wastes the years that matter."},
  {t:"Treatment when confirmed is usually CPAP, sometimes a dental appliance or surgery. CPAP is prescribed and titrated — do not buy a machine online before the study."}],
 ayur:["Classical texts describe Swasa and Nidra disorders; Kapha and Meda accumulation in the throat is the reading here.",
  "Weight reduction is the single most effective measure in both systems — even 10% of body weight noticeably reduces events.",
  "Nasya with Anu taila and steam inhalation help nasal patency but do not treat the airway collapse itself.",
  "Light early dinner, no alcohol at night, and regular pranayama support treatment; they do not replace it."],
 tests:["thyroid_basic"],
 seeDoc:["Any witnessed pause in breathing during sleep — get a sleep study","Falling asleep while driving, in meetings, or mid-conversation",
  "Morning headaches with high blood pressure","Snoring with a thick neck, obesity, or a family history of apnoea"],
 emerg:["Waking up gasping and unable to catch your breath while sitting up","Chest pain or palpitations on waking",
  "Blue or grey lips noticed by someone while you sleep","Falling asleep at the wheel — stop driving until you are assessed"]},

{id:"parkinsonism", rg:"systemic", nm:"Parkinsonism (suspected)", refer:true,
 al:["handwriting","handwriting getting smaller","small handwriting","hand feels stiff","hands feel stiff",
  "tremor at rest","hand shakes at rest","resting tremor",
  "shuffling walk","slow movements","stiff hand","stiffness and slowness","face has gone expressionless","soft voice",
  "arm does not swing","parkinson","kapkapi","haath kaanpta hai"],
 sys:"neuro", doctor:"Neurologist",
 modern:[
  {t:"Handwriting shrinking over months, slowness, stiffness, a tremor when the hand is at rest, reduced arm swing or a softer voice — that combination points to parkinsonism and needs a neurologist, not a home remedy."},
  {t:"It is diagnosed clinically by examination. Getting assessed early matters: treatment works well and the earlier years are the ones you keep the most function in."},
  {t:"Some medicines cause exactly this picture — long-term metoclopramide, prochlorperazine, flunarizine and several antipsychotics. Carry your full medicine list to the appointment; a drug cause can be reversible."},
  {t:"Never start levodopa or any anti-Parkinson drug on your own or on someone else's prescription — the diagnosis and dose have to be established first."},
  {t:"Meanwhile keep moving. Daily brisk walking, stretching, tai chi or yoga measurably slows functional decline, and clear the house of loose rugs and dark corners to prevent falls."}],
 ayur:["Kampavata is the classical correlate, described in detail with tremor, rigidity and slowness.",
  "Abhyanga with Mahanarayana or Bala taila followed by warm bath is the standard Vata-pacifying routine.",
  "Practitioner-supervised Ashwagandha and Kapikacchu (Mucuna) are traditionally used — but Mucuna contains natural levodopa and can interact with prescribed medication, so it must never be self-combined.",
  "Warm, unctuous, easily digested food; regular sleep; avoid cold, dry and irregular routines."],
 tests:["thyroid_basic"],
 seeDoc:["Handwriting shrinking, slowness or stiffness developing over months — see a neurologist",
  "A tremor that is present at rest and settles on movement","Falls, freezing at doorways, or a shuffling gait",
  "Any of this while on metoclopramide, flunarizine or an antipsychotic — tell the doctor immediately"],
 emerg:["Sudden onset over hours or days rather than months — that is a stroke pattern, not Parkinson's",
  "High fever with severe rigidity and confusion, especially after stopping or changing medication",
  "A fall with a head injury, particularly on blood thinners"]},

{id:"diabetic_neuropathy", rg:"limb", nm:"Diabetic peripheral neuropathy (suspected)", refer:true,
 al:["burning feet","burning feeling in my feet","burning feeling in both feet","burning in both feet","feet at night",
  "feet burn at night","tingling in both feet","numbness in both feet",
  "pins and needles in feet","feet feel numb","paer me jalan","pairon me jalan","sunn pan","neuropathy","nerve pain in feet",
  "cannot feel my feet"],
 sys:"neuro", doctor:"Physician / diabetologist",
 modern:[
  {t:"Burning, tingling or numbness in both feet, worse at night, in someone with diabetes is diabetic peripheral neuropathy. It is nerve damage from long-standing high sugars, and it needs a doctor's assessment rather than a painkiller."},
  {t:"The most important treatment is glycaemic control — it is the only thing shown to slow the nerve damage itself. Get HbA1c, kidney function and B12 checked; metformin depletes B12 and that alone can cause identical symptoms."},
  {t:"Ordinary painkillers barely touch nerve pain. The medicines that do work (pregabalin, duloxetine, amitriptyline) are prescription-only and dose-titrated — do not borrow anyone's."},
  {t:"Numb feet stop warning you about injury. Check both feet every single day including between the toes and the soles, using a mirror if you cannot bend."},
  {t:"Never walk barefoot, indoors or out. Never use a hot water bottle, heater or hot foot soak on numb feet — burns happen without pain being felt. Test water with your elbow."},
  {t:"Wear well-fitting closed footwear, cut nails straight across, and never let anyone cut corns or calluses with a blade at a salon."}],
 ayur:["Prameha-janya Vata-vyadhi is the classical framing — nerve involvement as a complication of long-standing Prameha.",
  "Padabhyanga (foot massage) with lukewarm — never hot — Ksheerabala or Mahanarayana taila is traditional; test the oil temperature on your elbow.",
  "Methi, jamun and karela support glycaemic control but never replace prescribed diabetes medication.",
  "Practitioner-guided Ashwagandha and Guduchi are used; tell your Ayurvedic doctor every allopathic medicine you take."],
 tests:["diabetes_panel","thyroid_basic"],
 seeDoc:["Burning or numb feet with diabetes — get HbA1c, kidney function and vitamin B12 tested",
  "Any cut, blister, crack or callus on a numb foot — same week, not later","Nail or skin fungal infection between the toes",
